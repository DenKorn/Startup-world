...
<div class="row">
    <div class="col-md-offset-1 col-md-10 col-lg-offset-0 col-lg-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">Бан этих пользователей нанёс бы серьезный ущерб форуму.
    ...
    <div class="col-md-offset-1 col-md-10 col-lg-offset-0 col-lg-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">На этих пользователей стоит обратить внимание, возможно некоторых из них стоит заблокировать.
                <table class="table table-striped table-hover text-center">
